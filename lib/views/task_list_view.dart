                              ...
                              onPressed: () {
                                ...
                                showDialog(
                                  ...
                                  builder: (context) {
                                    ...
                                    TextEditingController(text: viewModel.getTaskTitle(index));
                                    final deadlineController =
                                    TextEditingController(text: DateFormat('dd/MM/yyyy')
                                        .add_jm()
                                        .format(viewModel.getTaskDeadline(index)));
                                          ...
                                          TextField(
                                            ...
                                            onTap: () async {
                                              final picked = await showDatePicker(
                                                context: context,
                                                initialDate: viewModel.getTaskDeadline(index),
                                              ...
                                              if (picked != null) {
                                                final timePicked = await showTimePicker(
                                                  ...
                                                  initialTime: TimeOfDay.fromDateTime(
                                                    viewModel.getTaskDeadline(index),
                                                  ),
                                                );
                                                if (timePicked != null) {
                                                  ...
                                                  deadlineController.text =
                                                      DateFormat('dd/MM/yyyy').add_jm().format(deadline);
                                                }
                                              }
                                            },
                                          ),
                                      ...
                                      actions: [
                                        ...
                                        ElevatedButton(
                                          onPressed: () {
                                            ...
                                            final deadline = DateFormat('dd/MM/yyyy').add_jm()
                                                .parse(deadlineController.text.trim(), true);
                                            viewModel.editTask(index, title, deadline);
                                            Navigator.of(context).pop();
                                          },
